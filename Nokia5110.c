...
// Reset         (RST, pin 1) connected to PE3
// SSI0Fss       (CE,  pin 2) connected to PA3
// Data/Command  (DC,  pin 3) connected to PE2
...
// Reset         (RST, pin 4) connected to PE3
// Data/Command  (D/C, pin 5) connected to PE2
...
#define DC                      (*((volatile unsigned long *)0x40024010))
#define DC_COMMAND              0
#define DC_DATA                 0x04
#define RESET                   (*((volatile unsigned long *)0x40024020))
#define RESET_LOW               0
#define RESET_HIGH              0x08
...
void Nokia5110_Init(void){
  ...
  // chip active; horizontaling mode (V = 0); 
